...
import Form, { FormProps, FormHandle } from './components/Form';
...
export default function withTheme<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>(
  ...
  return forwardRef<FormHandle, FormProps<T, S, F>>(
    ({ fields, widgets, templates, ...directProps }: FormProps<T, S, F>, ref: ForwardedRef<FormHandle>) => {
